...
if (load_cfg('core_version')=='ebookcms_1.64') {
	...
	if (defined('DB_TYPE') && DB_TYPE == 'sqlite') {
		executeSQL("UPDATE [config] SET value = 'ebookcms_1.68' WHERE id = 1;");
	...
	if (defined('DB_TYPE') && DB_TYPE == 'sqlite') {
		executeSQL("UPDATE [config] SET field = 'core_version', value = 'ebookcms_1.68' WHERE id = 1;");}
	else {executeSQL("UPDATE `config` SET field = 'core_version', value = 'ebookcms_1.68' WHERE id = 1;");}
}
